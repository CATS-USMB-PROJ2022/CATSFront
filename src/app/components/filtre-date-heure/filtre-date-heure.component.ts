...
export class FiltreDateHeureComponent {
  ...
  // Getters //////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////////////
  getHeureDebut(): string { return this.StockageCookie.isHeureDebutDefaut(this.temp_heure_debut) ? "Heure début" : this.temp_heure_debut; }
  getHeureFin(): string { return this.StockageCookie.isHeureFinDefaut(this.temp_heure_fin) ? "Heure fin" : this.temp_heure_fin; }

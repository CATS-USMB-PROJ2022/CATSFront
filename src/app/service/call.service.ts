...
export class CallService {
  ...
  public postNumberCall(caisse: number, date_start: Date, date_end: Date, time_start: Time, time_end: Time, gt: string[], agences: string[], threshold: number): Observable<Call> {
    let post: Post;

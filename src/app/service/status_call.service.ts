...
export class StatusCallService {
  ...
  public postStatusCall(caisse: number, date_start: Date, date_end: Date, time_start: Time, time_end: Time, gt: string[], agences: string[], threshold: number, hno: number): Observable<StatusCall> {
    let post: Post;
